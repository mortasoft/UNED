...
public class Vista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtdatoBorrar = new javax.swing.JTextField();
        ...
        botonInsertar1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        botonInsertar1.setText("Borrar");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtdatoBorrar, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(botonInsertar1, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(error, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtdatoBorrar, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(botonInsertar1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2.getAccessibleContext().setAccessibleName("Arboles Binarios");
    ...
    private void botonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertarActionPerformed
        try {
            ...
            if (this.simulador.insertar(dato)) {
                ...
                error.setText("No se pudo insertar el dato. Intenta de nuevo...");
                txtdato.setText("");
            }
        } catch (Exception e) {
            error.setText("No se pudo insertar el dato. Intenta de nuevo...");
    ...
    private void botonInsertar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertar1ActionPerformed
       char dato = txtdatoBorrar.getText().charAt(0);
       this.simulador.borrar(dato);
       txtdatoBorrar.setText("");
       complementos();
    ...
    private javax.swing.JTextField txtdatoBorrar;
